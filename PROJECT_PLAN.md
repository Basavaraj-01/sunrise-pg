# PROJECT - Sunrise PG Tracking Document

## Project Summary
Sunrise PG is a property management/booking application using Next.js, FastAPI, and Neon Postgres.

## Initial Structure Finalized
- [x] Project folders created: db, backend, frontend.
